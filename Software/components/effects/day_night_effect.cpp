...
LedFrame DayNightEffect::get_led_data(DateTime t) { return LedFrame{}; }
...
esp_err_t DayNightEffect::deserialize(const char *json_text) {
  ...
  return EffectParser::parse_with_defaults(json_text, _path, sizeof(_path),
                                           [this](jparse_ctx_t *json_ctext) {

...
class RowScanEffect : public Effect {
  public:
	RowScanEffect() = default;
	~RowScanEffect() override = default;

	RowScanEffect(const RowScanEffect &) = delete;
	RowScanEffect &operator=(const RowScanEffect &) = delete;
	RowScanEffect(RowScanEffect &&) = delete;
	RowScanEffect &operator=(RowScanEffect &&) = delete;
	...
	static constexpr const char *kType = "row_scan";
	static constexpr const char *kDefaultConfigPath = "/effects/defaults/row_scan.json";
  ...
  private:
	...
	std::string name{"Row scan Effect"};
